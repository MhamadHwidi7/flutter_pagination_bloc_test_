...
import 'package:flutter_pagination_bloc_test/features/evolution_pokemon/presentation/manager/cubit/pokemons_evolution_cubit.dart';
import 'package:flutter_pagination_bloc_test/features/evolution_pokemon/presentation/widgets/pokemon_card.dart';
...
@RoutePage()
class PokemonEvalutionPage extends StatelessWidget {
  const PokemonEvalutionPage({super.key});

  @override
  Widget build(BuildContext context) => BlocProvider<PokemonsEvolutionCubit>(
        create: (context) =>
            getIt<PokemonsEvolutionCubit>()..getEvolutionsPokemons(),
        child: Scaffold(
          appBar: AppBar(
          ...
          body: Builder(
            builder: (context) {
              final pokemonCubitContext =
                  context.read<PokemonsEvolutionCubit>();
              return BlocConsumer<PokemonsEvolutionCubit,
                  PokemonsEvolutionState>(
                ...
                builder: (context, state) => state.when(
                  ...
                  success: (pokemons, canLoadMore) => CustomPaginationWidget(
                    ...
                    onLoading: () async {
                      pokemonCubitContext.getEvolutionsPokemons();
                    },
